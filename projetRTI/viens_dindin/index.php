...
<div class="container">
  <div class="row">
	...
	<form method="post" id="register_form" name="myForm">
		...
		<p for="tel">Nous allons utiliser uniquement votre numéro de téléphone pour la création de votre compte et vérifier que vous n'etes pas un robot</p>
			...
			<p style="font-size : 10px;">En continuant vous acceptez nos <a href="conditions.php">conditions générales d'utilisation</a></p>
		</form>
		</div>
    </div>
    <div class="col">
